...
public class AVLTree extends AbstractSelfBalancingBinarySearchTree {
    ...
    /**
     * @see Tree.AbstractBinarySearchTree#delete(int)
     */
//    删除的时候需要注意对删除结束后的节点高度进行处理
//    由于删除的时候是如果删除节点的左右子树都不为空的情况下,需要将被删除节点的右子树的最左节点作为替代结点a,
//    这样其父节点a_father就需要重新计算高度
    @Override
...
//                重新计算删除节点的父节点的高度
     ...
     */
//    平衡操作的实质是一边就算高度一边观察是否要平衡,一旦平衡后则不需要向上计算高度变化原因是平衡使得参与平衡操作的最高点
//     平衡后使得上层结点最大高度不变
